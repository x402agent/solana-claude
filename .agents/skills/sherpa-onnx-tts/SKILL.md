...
1. Download the runtime for your OS (extracts into `~/.solanaos/tools/sherpa-onnx-tts/runtime`)
2. Download a voice model (extracts into `~/.solanaos/tools/sherpa-onnx-tts/models`)

Update `~/.solanaos/solanaos.json`:
...
```json5
{
  skills: {
    entries: {
      "sherpa-onnx-tts": {
        env: {
          SHERPA_ONNX_RUNTIME_DIR: "~/.solanaos/tools/sherpa-onnx-tts/runtime",
          SHERPA_ONNX_MODEL_DIR: "~/.solanaos/tools/sherpa-onnx-tts/models/vits-piper-en_US-lessac-high",
        },
      },
    },
  },
