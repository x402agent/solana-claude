...
- Or set `skills."nano-banana-pro".apiKey` / `skills."nano-banana-pro".env.GEMINI_API_KEY` in `~/.solanaos/solanaos.json`
...
- The script prints a `MEDIA:` line for SolanaOS to auto-attach on supported chat providers.
