...
The reward/position program in this directory is synchronized to the devnet
deploy keypair:

```text
Program ID:      5bp3bDnWYdjiYyB99XWWi6h8ga2wnB1TxuRUb4VNJrTn
Cluster:         devnet
```
...
The program ID in `lib.rs` must stay synchronized with
`target/deploy/clawd_stake-keypair.json`.
