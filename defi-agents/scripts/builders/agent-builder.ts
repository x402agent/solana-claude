...
import { ClawdAgent, clawdAgentSchema } from '../schema/agentMeta';
...
class AgentBuilder {
  ...
  buildSchema = () => {
    ...
    const schema = zodToJsonSchema(clawdAgentSchema);
    const fileName = `clawdAgentSchema_v${meta.schemaVersion}.json`;
