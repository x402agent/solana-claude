...
import type { ConvexAgentClient } from "./clawd/convex-client.js";

export type { ConvexAgentClient } from "./clawd/convex-client.js";
...
export interface AutomatonConfig {
  ...
  // CLAWD Convex backend for agent tracking, heartbeats, and data storage
