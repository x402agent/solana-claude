...
crons.interval(
  'mark stale CLAWD agents inactive',
  { seconds: 300 }, // every 5 minutes
  internal.clawd.agents.markStaleAgentsInactive,
  { staleThreshold: 900_000 }, // 15 minutes without heartbeat = stale
);

crons.interval(
  'prune old CLAWD heartbeats',
  { seconds: 3600 }, // every hour
  internal.clawd.heartbeats.pruneOldHeartbeats,
  { olderThan: 7_200_000 }, // keep last 2 hours of raw heartbeats
);
