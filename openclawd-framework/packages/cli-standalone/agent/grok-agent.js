...
import { TextEditorTool, MorphEditorTool, BashTool, TodoTool, ConfirmationTool, SearchTool, SolanaTool, DFlowTool, WalletTool, TokenLaunchTool, PolymarketTool, BagsTool, KalshiTool, } from "../tools/index.js";
...
export class GrokAgent extends EventEmitter {
    ...
    constructor(apiKey, baseURL, model, maxToolRounds) {
        ...
        const resolvedApiKey = providerCfg.apiKey || apiKey || (providerCfg.provider === "ollama" ? "ollama" : "");
