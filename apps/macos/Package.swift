...
// Package manifest for the SolanaOS macOS companion app, built on the OpenClaw codebase.
...
let package = Package(
    ...
    products: [
        .library(name: "SolanaOSIPC", targets: ["OpenClawIPC"]),
        .library(name: "SolanaOSDiscovery", targets: ["OpenClawDiscovery"]),
        .executable(name: "SolanaOS", targets: ["OpenClaw"]),
        .executable(name: "solanaos-mac", targets: ["OpenClawMacCLI"]),
