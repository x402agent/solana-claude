...
Drop the JSON into [`solana-clawd-agents/src/`](../src/) and open a PR — see [DEPLOYMENT.md](./DEPLOYMENT.md) for the four paths to getting live on [x402.wtf/agents](https://www.x402.wtf/agents).
