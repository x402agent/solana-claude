...
SDK_GRAPH_URL="${SDK_GRAPH_URL:-https://x402.wtf/sdk}"
SDK_MANIFEST_URL="${SDK_MANIFEST_URL:-https://x402.wtf/api/solana-clawd/sdk}"
...
printf "  ${CYAN}curl ${SDK_MANIFEST_URL}${CR}      — SDK graph stats\n"
...
printf "  ${CYAN}${SDK_GRAPH_URL}${CR}        — hosted SDK graph\n"
