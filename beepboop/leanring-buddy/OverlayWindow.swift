...
struct BlueCursorView: View {
    ...
    private let fullWelcomeMessage = "hey! i'm clawd"
    ...
    var body: some View {
        ZStack {
            ...
            // Onboarding prompt — "press control + option and introduce yourself"
            // streamed after the welcome animation.
            ...
            // Lobster claw cursor — shown when idle or while TTS is playing (responding).
        ...
        .onDisappear {
            ...
            companionManager.clearOnboardingPrompt()
        }
        ...
        Timer.scheduledTimer(withTimeInterval: 0.03, repeats: true) { timer in
            guard currentIndex < self.fullWelcomeMessage.count else {
                ...
                DispatchQueue.main.asyncAfter(deadline: .now() + 2.5) {
                    ...
                    self.companionManager.finishOnboardingIntro()
                }
                return
            }
...
// MARK: - Clawd Cursor Waveform

/// A small lobster-colored waveform that replaces the cursor while
...
// MARK: - Clawd Cursor Spinner

/// A small lobster-colored spinning indicator that replaces the cursor
