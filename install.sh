...
OPENCLAWD_SDK_GRAPH_URL="${OPENCLAWD_SDK_GRAPH_URL:-https://x402.wtf/sdk}"
OPENCLAWD_SDK_MANIFEST_URL="${OPENCLAWD_SDK_MANIFEST_URL:-https://x402.wtf/api/solana-clawd/sdk}"
...
printf "  ${DIM}SDK Graph : $OPENCLAWD_SDK_GRAPH_URL${RESET}\n"
...
printf "  ${DIM}SDK smoke: curl $OPENCLAWD_SDK_MANIFEST_URL | jq '.data.stats'${RESET}\n"
printf "\n"
convergence
